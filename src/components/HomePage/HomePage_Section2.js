      ...
      <div className="Homepage_section2">
        <div className="row">
          <div className="images">
            ...
            <ProgressiveImage
              src={showingBracelet2}
              placeholder={showingBracelet2_compressed}
            >
              {(src) => (
                <img
                  className="hide img-2"
                  src={src}
                  alt="girl holding Jewellery"
                />
              )}
            </ProgressiveImage>
          </div>
          <div className="text">
            <p>
              Tira is a Luxury jewellery that reflects elegance with the focus
              on the highest quantily of silver, gold. All jewellery crafeted in
              Toronto, Canada.
            </p>
          </div>
        </div>
